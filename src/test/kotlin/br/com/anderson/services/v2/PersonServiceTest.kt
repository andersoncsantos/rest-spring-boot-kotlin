...
internal class PersonServiceTest {
    ...
    fun findAll() {
        ...
        assertTrue(personOne.links.toString().contains("</person/v2/1>;rel=\"self\""))
        ...
        assertTrue(personFour.links.toString().contains("</person/v2/4>;rel=\"self\""))
        ...
        assertTrue(personSeven.links.toString().contains("</person/v2/7>;rel=\"self\""))
